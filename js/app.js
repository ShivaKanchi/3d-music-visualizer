// Function to create a specified number of lines
    ...
    // Note: This function is attached to the 'mousemove' event in js/visualizer.js
    ...
    // Note: This function is attached to the 'wheel' event in js/visualizer.js
    ...
    // Note: This function is attached to the 'click' event on the canvas in js/visualizer.js
    ...
    // Note: This function is attached to the 'mousedown' event on the canvas in js/visualizer.js
    ...
    // Note: This function is attached to the 'mouseup' event on the canvas in js/visualizer.js
    function onMouseUp(event) {
      isDragging = false;
    }

    // Handle mouse move for dragging and rotation
    // Note: This function is attached to the 'mousemove' event on the canvas in js/visualizer.js
    ...
    // Note: This function is attached to the 'resize' event on window in js/visualizer.js
